  ...
  #  add_column :films, :poster_updated_at,   :datetime
   # add_column :films, :trailer_updated_at,   :datetime
    ...
    Movie.all.each do |movie|
      hash = {}
      hash[:poster_updated_at] =  movie.updated_at unless movie.poster_file_name.blank?
      hash[:trailer_updated_at] = movie.updated_at unless movie.trailer_file_name.blank?
